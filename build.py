...
SCORES_URL = "https://ctpl.pickleballscores.com"  # same platform as REGISTER_URL; separate constant in case Jon wants a deep link to schedule/standings specifically
...
def head(path, title, description, schema_blocks, noindex=False):
...
<header class="site-header">
  <div class="container">
    ...
    <nav class="primary-nav" id="primary-nav" aria-label="Primary">
      ...
      <a href="{SCORES_URL}" target="_blank" rel="noopener">Scores &amp; Schedule</a>
      <a href="/rules-forms"{cur('/rules-forms')}>Rules &amp; Forms</a>
      <a href="/news/"{cur('/news/')}>News</a>
      <a href="/about"{cur('/about')}>About</a>
      <a href="/contact"{cur('/contact')}>Contact</a>
      <a href="{HEADER_REGISTER_URL}" class="nav-cta" target="_blank" rel="noopener">Register</a>
    </nav>
...
def register_banner():
  ...
  <div class="container register-banner-inner">
    <span class="register-banner-text"><strong>Season registration is open.</strong> Register to play or enter match scores on our league platform.</span>
    <div class="register-banner-links">
      <a class="btn btn-primary btn-sm" href="{GENERAL_REGISTER_URL}" target="_blank" rel="noopener">Register</a>
    ...
    <div class="footer-nap">
      ...
      <div>
        ...
        <div class="footer-social">
          {social_icon("facebook", FACEBOOK_URL)}
...
def page(path, title, description, body, schema_blocks=None, nav_active=None, noindex=False):
    schema_blocks = schema_blocks or []
    active = nav_active if nav_active is not None else path
    html = f'''<!doctype html>
<html lang="en">
<head>
{head(path, title, description, schema_blocks, noindex)}
</head>
<body>
{header(active)}
{register_banner()}
